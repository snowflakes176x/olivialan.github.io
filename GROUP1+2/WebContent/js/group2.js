...
var PS2 = ["P0",
    "P26", "P1", "P2", "P3", "P6",
    "P7", "P4", "P5", "P8", "P9", "P10", "P11", "P12", "P13", "P14", "P15", "P16", "P18", "P17", "P19", "P20", "P21",
    "P22", "P23", "P24", "P25"
];

var CS2 = ["C0", "C1", "C2", "C3", "C4", "C5", "C6", "C7", "C8", "C9", "C10", "C11", "C12",

    "C13", "C14", "C15", "C16", "C17", "C18", "C19", "C20", "C21", "C22", "C23", "C24",
    "C25", "C26", "C27", "C28", "C29", "C30", "C31", "C32", "C33", "C34", "C35", "C36", "C37", "C38",
    "C39", "C40", "C41", "C42", "C43", "C44", "C45", "C46", "C47", "C48", "C49", "C50", "C51", "C52",
    "C53", "C54", "C55", "C56",
    "C73", "C74", "C65",

    "C57", "C58", "C59", "C60", "C61", "C62", "C63", "C66",
    "C67", "C68", "C69", "C70", "C71", "C72", "C75", "C76", "C77", "C78", "C79"
];
var BGColor = "#252525";
var PPMColor = [{
        "m": "A",
        ...
        function() {
            ...
            CC.prototype.display = function() {
                ...
                if (this.c2.type == "arc") {
                    ...
                    main.strokeStyle = this.color;
                    main.beginPath();
                    main.moveTo(this.c1.x, this.c1.y + 260);
                    main.lineTo(this.c2.x, this.c2.y);
                    main.stroke();
                    if (this.c1.y + this.c1.name.length * 18 + 10 < this.c1.y + 260) {
                        main.beginPath();
                        main.moveTo(this.c1.x, this.c1.y +
                            this.c1.name.length * 18 + 10);
                        main.lineTo(this.c1.x, this.c1.y + 260);
                        main.stroke()
                    }
                }
            };

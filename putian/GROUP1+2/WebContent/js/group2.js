var PList2 = [{id:"P0",name:"曾真",photo:"",information:""}, 
              {id:"P1",name:"陈国兴",photo:"",information:""},
              {id:"P2",name:"陈国雄",photo:"",information:""}, 
              {id:"P3",name:"陈焕宁",photo:"",information:""},
              ...
              {id:"P8",name:"陈新喜",photo:"",information:""},  
...
var CList2 = [{id:"C0",name:"杭州虹桥医院",m:"B",information:""},
              {id:"C1",name:"杭州天目山医院",m:"B",information:""},
              {id:"C2",name:"宁波虹桥医院",m:"B",information:""},
              ...
              {id:"C8",name:"东莞康桥妇科医院",m:"B",information:""},
              {id:"C9",name:"东莞塘厦同仁妇产医院",m:"B",information:""},
              ...
              {id:"C18",name:"杭州真爱医院",m:"B",information:""},
              ...
              {id:"C32",name:"重庆都市丽人医院",m:"B",information:""},
              {id:"C33",name:"重庆涪陵和美妇产医院",m:"B",information:""},
              {id:"C34",name:"重庆万州和美妇产医院",m:"B",information:""},
              {id:"C35",name:"重庆现代女子医院",m:"B",information:""},
              {id:"C36",name:"福州现代妇产医院",m:"B",information:""},
              {id:"C37",name:"贵阳和美妇产医院",m:"B",information:""},
              {id:"C38",name:"贵阳现代女子医院",m:"B",information:""},
              {id:"C39",name:"深圳和美妇儿科医院",m:"B",information:""},
              {id:"C40",name:"武汉现代女子妇科医院",m:"B",information:""},
              {id:"C41",name:"莆田盛兴医院",m:"B",information:""},
              {id:"C42",name:"广州番禹玛莉亚肛肠医院",m:"B",information:""},
              {id:"C43",name:"广州现代医院",m:"B",information:""},
              {id:"C44",name:"广州益寿医院",m:"B",information:""},
              {id:"C45",name:"广州长安医院",m:"B",information:""},
              ...
              {id:"C54",name:"黑龙江和美妇产医院",m:"B",information:""},
              {id:"C55",name:"山西现代妇产医院",m:"B",information:""},
              {id:"C56",name:"厦门友好妇科",m:"B",information:""},
             ...
             {id:"C76",name:"深圳美莱美容医院",m:"B",information:""},
             {id:"C77",name:"重庆华美美莱整形医院",m:"B",information:""},
             {id:"C78",name:"昆明华美美莱整形医院",m:"B",information:""},
             {id:"C79",name:"山西沃德投资有限公司",m:"A",information:""},
             {id:"C80",name:"重庆万州华美紫馨整形美容医院",m:"B",information:""},
             ];
...
var PS2 = ["P0","P26","P3","P1","P2","P7", 
		"P6","P5", "P4","P8" , "P11","P13","P15","P14","P16","P10","P19","P17","P18","P12", "P20", "P21",
		"P24","P25"
		];

var CS2 = ["C2","C8","C9", "C4","C17","C15","C16","C13","C14",
            "C12","C18",
                     
          "C3", "C5","C6","C7","C0", "C1","C21","C10","C11","C76","C77","C78","C80",
           "C25","C27","C37","C30","C32","C35","C40","C33","C34","C36","C38","C39","C54","C42", "C45", "C43", "C46","C47","C48","C49","C51",
                
           "C26",
           "C28","C29",
          
           "C31","C41","C20","C19","C44","C52","C22", "C23","C50","C55","C56","C24",
           
           "C57","C58","C63","C59","C60","C61","C62","C65","C79","C66","C67","C68","C69","C70","C74","C73","C71","C72","C75"
...
.write("<div style='background-color:"
		+ BGColor
		+ ";width:100%;'><div id='mainDiv2'><canvas id='mainCanvas2'></canvas></div></div>");
var WIDTH = 1240;
var HEIGHT2 = 900;
var time = 0;
var mouseX = 0;
...
function() {
	...
	$("#mainCanvas2").attr("width", WIDTH);
	$("#mainCanvas2").attr("height", HEIGHT2);
	$("#mainCanvas2").css({
		"display" : "block",
		"margin-left" : "auto",
		"margin-right" : "auto",
	...
	var main = canvas2.getContext("2d");
	...
	CC.prototype.display = function() {
		...
		if (this.c2.type == "arc") {
			...
			main.strokeStyle = this.color;
			main.beginPath();
			main.moveTo(this.c1.x, this.c1.y + 300);
			main.lineTo(this.c2.x, this.c2.y);
			main.stroke();
			if (this.c1.y + this.c1.name.length * 18 < this.c1.y + 300) {
				main.beginPath();
				main.moveTo(this.c1.x, this.c1.y
						+ this.c1.name.length * 18);
				main.lineTo(this.c1.x, this.c1.y + 300);
				main.stroke();
			}
		}
	};
	...
	CP.prototype.display = function() {
		...
		if (this.p.name == "林玉明" && this.c.m == "B") {
			main.beginPath();
			main.moveTo(this.p.x, this.p.y + 72);
			main.lineTo(this.p.x + 190, this.p.y + 130);
			//alert(this.p.x + 190);this.p.x + 190=799
			//alert(this.p.y + 130);this.p.y + 130=230
			main.stroke();
			main.beginPath();
			main.moveTo(this.p.x + 190, this.p.y + 130);
			main.lineTo(this.p.x + 190, this.p.y + 430);
			main.stroke();
			
			main.beginPath();
			main.moveTo(this.p.x + 190, this.p.y + 430);
			main.lineTo(this.c.x, this.c.y);
			main.stroke();
		}
		else if(this.p.name == "林玉国" && this.c.m == "B" || this.p.name == "林玉盛" && this.c.m == "B" || this.p.name == "林建芳" && this.c.m == "B" 
			|| this.p.name == "林志忠" && this.c.m == "B" || this.p.name == "林志程" && this.c.m == "B" || this.p.name == "林志通" && this.c.m == "B"
				|| this.p.name == "吴亚平" && this.c.name == "重庆涪陵和美妇产医院" || this.p.name == "吴亚平" && this.c.name == "黑龙江和美妇产医院" 
				|| this.p.name == "林新疆" && this.c.name == "长沙现代女子医院" || this.p.name == "林新疆" && this.c.name == "长沙南方骨外科医院" || this.p.name == "林新疆" && this.c.name == "北京年轮中医骨科医院"){
			main.beginPath();
			main.moveTo(this.p.x, this.p.y + 72);
			main.lineTo(799, 230);
			main.stroke();
			if(this.p.name == "林志通" && this.c.name == "深圳和美妇儿科医院" || this.p.name == "吴亚平" && this.c.name == "黑龙江和美妇产医院"
			||  this.p.name == "吴亚平" && this.c.name == "重庆涪陵和美妇产医院" || (this.c.name == "上海仁爱医院")
			||  (this.c.name == "广州现代医院") || this.c.name == "广州番禹玛莉亚肛肠医院"||  this.c.name == "广州长安医院" || this.p.name == "林玉国" && this.c.name == "南通和美家妇产科医院"	){
				main.beginPath();
				main.moveTo(799, 230);
				main.lineTo(799,530);
				main.stroke();
		...
		}else if(this.p.name == "陈新喜" && this.c.m == "B" || this.p.name == "林新疆" && this.c.name == "长沙年轮骨科医院" || this.p.name == "林新疆" && this.c.name == "长沙恒生手外科医院"
			|| this.p.name == "林明杰" && this.c.m == "B" || this.p.name == "陈建煌" && this.c.m == "B" || this.p.name == "陈建新" && this.c.m == "B"
			|| this.p.name == "陈金秀" && this.c.m == "B" || this.p.name == "陈金章" && this.c.m == "B" || this.p.name == "陈国雄" && this.c.m == "B"
			|| this.p.name == "陈国兴" && this.c.name == "昆山虹桥医院" || this.p.name == "陈国兴" && this.c.name == "温州建国医院" 
			|| this.p.name == "曾真" && this.c.name == "杭州虹桥医院" || this.p.name == "曾真" && this.c.name == "杭州天目山医院"){
			main.beginPath();
			main.moveTo(this.p.x, this.p.y + 72);
			main.lineTo(403, 230);
			main.stroke();
			if(this.p.name == "林新疆" && this.c.name == "长沙年轮骨科医院" || this.p.name == "林新疆" && this.c.name == "长沙恒生手外科医院"){
				main.beginPath();
				main.moveTo(403, 230);
				main.lineTo(403,530);
				main.stroke();
	...
	for ( var i = 0; i < PS2.length; i++) {
		...
		if (PS2[i] != "") {
			if (PS2[i].charAt(0) == "G") {
				var g = new G(PS2[i].slice(1));
				g.x = x + i * space;
				g.y = y;
				GArray.push(g)
			} else {
				var pData = getPDataByID(PS2[i]);
				var p = new P(pData.id, pData.name,
						pData.photo, pData.information);
				p.x = x + 325 + i * 1.1 *space;
				p.y = y;
				PArray.push(p)
			}
		}
	...
	for ( var i = 0; i < CS2.length; i++) {
		if (CS2[i] != "TOP_SPACE" && CS2[i] != "BOTTOM_SPACE") {
			var cData = getCDataByID(CS2[i]);
	...
	function CtoCs(c) {
		for ( var i = 0; i < CCList2.length; i++) {
			if (CCList2[i].c1 == c) {
				return true
			}
		}
	...
	for ( var i = 0; i < PPList2.length; i++) {
		var p1 = getPByID(PPList2[i].p1);
		var p2 = getPByID(PPList2[i].p2);
		var pp = new PP(p1, PPList2[i].to, p2, PPList2[i].m);
		PPArray.push(pp)
	}
	for ( var i = 0; i < CPList2.length; i++) {
		var c = getCByID(CPList2[i].c);
		var p = getPByID(CPList2[i].p);
		var cp = new CP(c, CPList2[i].to, p, CPList2[i].m);
		CPArray.push(cp)
	}
	for ( var i = 0; i < CCList2.length; i++) {
		var c1 = getCByID(CCList2[i].c1);
		var c2 = getCByID(CCList2[i].c2);
		var cc = new CC(c1, CCList2[i].to, c2, CCList2[i].m);
		CCArray.push(cc)
	}
	...
	(function draw() {
		...
		main.clearRect(0, 0, canvas2.width, canvas2.height);
		main.lineWidth = 1;
		//info.display();
	...
	function CCMLegend(x, y, space) {
		for ( var i = 0; i < CCMColor2.length; i++) {
			if(CCMColor2[i].name !=""){
				main.globalAlpha = 1;
				main.fillStyle = CCMColor2[i].color;
				main.fillRect(x - 8, y - 1, 16, 2);
				...
				main.fillStyle = "#ccc";
				main.font = "12px 'Microsoft YaHei', 微软雅黑";
				main.fillText(CCMColor2[i].name, x + 14, y + 4);
				x += main.measureText(CCMColor2[i].name).width
						+ space;
			}
